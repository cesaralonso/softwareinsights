...
<div class="container">
  ...
  <div class="row py-3">
    <div class="col-sm-12">
      <h2>CURSO SOFTWARE DEVELOPER FULLSTACK SEMI-SENIOR</h2>
      <h3>Especificaciones del curso</h3>
      <p>Curso dedicado a desarrolladores con conocimientos básicos que deseen ampliar su conocimiento.</p>
      ...
      <ul>
        <li>
        Desarrollar páginas dinámicas con JavaScript, HTML5 y CSS
        </li>
        <li>    
      ...
      <h3>¿Que lograré?</h3>
      <p>Al finalizar el curso, tendras los conocimientos necesarios para obtener un empleo como desarrollador web nivel semi-senior.</p>
      <h3>¿Que obtendré?</h3>
      <p>
      ...
      <h3>Costo y duración</h3>
        <p>
          $1,500.00 pesos mexicanos y con duracion de 30 horas equivalente a un mes y medio.
        </p>
    </div>
  </div>
</div>
